...
public class SetSpend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setspend);

        //接受数据
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        String[] spendArray = bundle.getStringArray("spend");
        ...
        spendDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(SetSpend.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        //删除
        dele = findViewById(R.id.deleSpend);
        dele.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyOpenHelper myOpenHelper = new MyOpenHelper(SetSpend.this);
                db = myOpenHelper.getWritableDatabase();
                db.delete("addout","_id="+spendArray[0],null);
                Toast.makeText(getApplicationContext(), "删除成功", Toast.LENGTH_SHORT).show();
                Intent intent1 = new Intent(SetSpend.this,MySpend.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.update("addout",contentValues,"_id=?",new String[]{spendArray[0]});
